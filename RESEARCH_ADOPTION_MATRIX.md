...
| Imported corpus            | 552 documents, 2,071 hierarchical units and 1,192 relations reported through `akp_status`                                                                                                                                          | [`packages/vault-importer/src/index.ts`](packages/vault-importer/src/index.ts)                                                                                             |
...
| Critical retrieval eval    | Run `6ffd70cc-d30e-4714-b74c-7b7f6a49a1a6`: 4/4 cases passed; Recall@10 `1.0`; MRR `0.3875`; nDCG@10 `0.5266485`; citation precision `0.625`; unsupported-answer rate `0`; mean latency `25.42 ms`                                 | [`evals/gold.jsonl`](evals/gold.jsonl), [`packages/evaluation/src/index.ts`](packages/evaluation/src/index.ts)                                                             |
...
1. The gold set has only **4 cases**. Passing it is a smoke gate, not broad
...
- **our_capability:** 18 tools over stdio; Streamable HTTP implementation with
...
- **our_capability:** Agents receive bounded structured results through 18 MCP
