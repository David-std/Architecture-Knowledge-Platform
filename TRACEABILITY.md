...
The following remains intentionally unfilled until its own commands execute:
read-only vault validator/eval outputs, deterministic vault manifest and ZIP,
staged private-file audit, Git commit, annotated tag and archive SHA-256. Their
absence must never be represented as evidence that already passed.
